...
class DeliveringOrderDetailSheet extends StatelessWidget {
  const DeliveringOrderDetailSheet({
    super.key,
    required this.order,
            ...
            _Card(
              child: Column(
                ...
                children: [
                  ...
                  MapPreviewCard(order: order, onMapTap: onMapTap),
                ],
              ),
            ),
            const SizedBox(height: 13),
            ...
            OutlinedButton.icon(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      'Đơn đang được giao nên không thể hủy lúc này.',
                    ),
                  ),
                );
              },
              icon: const Icon(Icons.info_outline_rounded),
              label: const Text('Không thể hủy khi đang giao'),
